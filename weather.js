 function weather( cityId, el ) {
            ...
            function render(weatherData){
                ...
                // container.innerHTML = `<p style="font-style:10pt;" >${location.city}, ${location.region}</p>`
                // document.getElementById(id).style.font-size = "10em";
                // current weather
                ...
                <div class="weather type-small">
                    <h4>Today</h4>
                    <h6>Currently ${condition.temp} &deg;C., and ${result[0].description}</h6>
